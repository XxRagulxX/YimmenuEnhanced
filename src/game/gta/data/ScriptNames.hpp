...
namespace YimMenu
{
	static constexpr auto scriptNames = std::to_array({
	    ...
	    "mansion_carmod",
	    "mansion_club_bar",
	    "mansion_club_seating",
	    "mansion_guest_bedroom_seating",
	    "mansion_lobby_seating",
	    "mansion_lower_basement_seating",
	    "mansion_lower_east_wing_seating",
	    "mansion_outside_seating",
	    "mansion_seating",
	    "mansion_upper_balcony_seating",
	    "mansion_upper_floor_seating",
	    "mansion_water_seating",
	    "martin1",
	    "maude1",
	    "maude_postbailbond",
	    "me_amanda1",
