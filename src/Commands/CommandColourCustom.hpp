...
namespace Stand
{
	class CommandColourCustom : public CommandLegacy
	{
	protected:
	...
	public:
		CommandColourCustom(std::string name, std::string label, std::string description, ImVec4 color = ImVec4(1.0f, 1.0f, 1.0f, 1.0f));
		ImVec4 GetState();
