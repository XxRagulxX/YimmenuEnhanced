...
namespace YimMenu::Features
{
	...
	// ColorCommand/GridItemCommandColor has no "copy another command's
	...
	class CommandNotifyBorderColour : public ColorCommand
	{
	public:
		CommandNotifyBorderColour() :
		    ColorCommand("notifyborder", "Border Colour", "The notification card's own border/remaining-time colour.", ImVec4(1.f, 0.f, 1.f, 1.f))
		{
		}
	...
	static StandWidgets::ColourRainbow _NotifyBorderColourRainbow{"notifyborderrainbow",
	    "Rainbow Mode",
