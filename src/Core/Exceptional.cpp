...
namespace Stand
{
	...
	long handleExceptionInErrorReporting(_EXCEPTION_POINTERS* exp, const char* msg) noexcept
	{
		std::string full_msg = msg;
		full_msg.append(Exceptional::getExceptionName(exp));
		g_logger.log(std::move(full_msg));
