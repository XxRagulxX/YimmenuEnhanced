...
enum eSCRIPT_HUD_COMPONENT
{
	...
	HUD_MP_RANK_BAR,
	HUD_DIRECTOR_MODE,
	HUD_CHIP, // used with BEGIN_SCALEFORM_SCRIPT_HUD_MOVIE_METHOD only for SET_PLAYER_CHIPS
	HUD_CHIP_CHANGE, // used with BEGIN_SCALEFORM_SCRIPT_HUD_MOVIE_METHOD only for SET_PLAYER_CHIP_CHANGE
