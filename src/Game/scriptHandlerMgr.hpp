...
namespace rage
{
	...
	public:
		...
		static void SendMessageToPlayer(const netPlayer& player, const Msg& msg, const netPlayer* sender = nullptr)
		{
			// Not quite the real function:
			// - Real function is not static
			// - Real function returns a bool but we don't need it
