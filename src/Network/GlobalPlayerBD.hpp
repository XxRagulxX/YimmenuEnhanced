...
struct GlobalPlayerBDEntry
{
	...
	NETWORK_INDEX MansionHeliNetId;       // added b3407
	...
	SCR_BOOL IsRockstarDev; // dev dlc check and not the CNetGamePlayer flag so can be used to detect StandEnhanced
